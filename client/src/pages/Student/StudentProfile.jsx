...
import { Camera, User, Shield, List, ChevronLeft, ChevronRight, Activity } from 'lucide-react';
                    ...
                    <Card style={{ textAlign: 'center' }}>
                        <div className="profile-avatar-container" style={{ position: 'relative', width: '120px', height: '120px', margin: '0 auto 20px' }}>
                            {user?.avatar ? (
                                ...
                                <div style={{ width: '100%', height: '100%', borderRadius: '50%', background: 'linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '3rem', fontWeight: 'bold' }}>
                        ...
                        <div style={{ marginTop: '25px', textAlign: 'left' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '0.9rem' }}>
                                ...
                                <span style={{ fontWeight: 'bold', color: 'var(--primary-color)' }}>{completionPercentage}% Complete</span>
                            </div>
                        ...
                        <Card>
                            ...
                            <div className="timeline" style={{ padding: '20px 0' }}>
                                {activityData.activities.length > 0 ? (
                                    ...
                                    <p style={{ textAlign: 'center', color: 'var(--text-gray)', padding: '40px' }}>No activity found yet.</p>
                                )}
                            </div>
                            ...
                            {activityData.pages > 1 && (
                                <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', marginTop: '20px', alignItems: 'center' }}>
                                    <Button
                                        ...
                                        onClick={() => fetchActivity(activityData.page - 1)}
                                        style={{ padding: '8px' }}
                                    >
                                        <ChevronLeft size={18} />
                                    </Button>
                                    ...
                                    <Button
                                        variant="outline"
                                        disabled={activityData.page === activityData.pages}
                                        onClick={() => fetchActivity(activityData.page + 1)}
                                        style={{ padding: '8px' }}
                                    >
